public class University    //public keyword means class is available to other classes in this program
{
    ...
    //constructor method 
    public University(int ranking, String name, String country, String CourseRequirements) 
    {        
    ...
    {
        return this.ranking + ", " + this.name + ", " +   this.country + ", " + this.CourseRequirements;
    }
    ...
    public String getRequirements() {return CourseRequirements;}
    ...
    public void setRequirements(String CourseRequirements){this.CourseRequirements = CourseRequirements;}
}
